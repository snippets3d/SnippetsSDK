...
public class SnippetsSimpleController : MonoBehaviour
{
    ...
    [Tooltip("Whether the custom animation plays once or loops until snippet playback ends when Action is Snippet + Custom Animation.")]
    public SnippetsActorRegistry.CustomAnimationPlaybackMode customAnimationPlaybackMode =
        SnippetsActorRegistry.CustomAnimationPlaybackMode.PlayOnceThenIdle;
    ...
    IEnumerator ExecuteSnippetWithCustomAnimation()
    {
        ...
        registry.PlaySnippetSpeechWithCustomAnimation(
            actorIndex,
            snippetIndex,
            customAnimationIndex,
            snippetMaskMode,
            customAnimationPlaybackMode);
...
public class SnippetsSimpleControllerEditor : Editor
{
    ...
    static readonly GUIContent GC_CustomAnimationPlayback = new("Custom Animation Playback", "Play the custom animation once, or loop it until snippet playback ends.");
    ...
    public override void OnInspectorGUI()
    {
        ...
        switch (ctrl.action)
        {
            ...
            case SnippetsSimpleController.ActionType.SnippetWithCustomAnim:
                DrawSnippet(ctrl);
                DrawCustomAnimation(ctrl);
                ctrl.customAnimationPlaybackMode =
                    (SnippetsActorRegistry.CustomAnimationPlaybackMode)EditorGUILayout.EnumPopup(
                        GC_CustomAnimationPlayback,
                        ctrl.customAnimationPlaybackMode);
