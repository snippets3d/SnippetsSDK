...
public class SnippetsFlowController : MonoBehaviour
{
    ...
    public class Step
    {
        ...
        [Tooltip("Whether the custom animation plays once or loops until snippet playback ends when Step Type is Snippet + Custom Animation.")]
        [InspectorName("Custom Animation Playback")]
    ...
    IEnumerator ExecuteSnippetWithCustomAnim(Step step)
    {
        ...
        registry.PlaySnippetSpeechWithCustomAnimation(
            ...
            step.customAnimationPlaybackMode);
