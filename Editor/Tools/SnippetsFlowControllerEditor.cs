...
public class SnippetsFlowControllerEditor : Editor
{
    ...
    static readonly GUIContent GC_CustomAnimationPlayback = new("Custom Animation Playback");
    ...
    void BuildStepsList()
    {
        ...
        _stepsList.onAddCallback = list =>
        {
            ...
            el.FindPropertyRelative("customAnimationPlaybackMode").enumValueIndex =
                (int)SnippetsActorRegistry.CustomAnimationPlaybackMode.PlayOnceThenIdle;
    ...
    float ComputeElementHeight(SerializedProperty stepProp)
    {
        ...
        switch (type)
        {
            ...
            case SnippetsFlowController.StepType.SnippetWithCustomAnim:
                lines += 1; // snippet
                lines += 1; // custom animation
                lines += 1; // custom animation playback
    ...
    void DrawStepElement(Rect rect, int index, SerializedProperty stepProp, bool isActive)
    {
        ...
        var customAnimationPlaybackModeProp = stepProp.FindPropertyRelative("customAnimationPlaybackMode");
        ...
        switch (newType)
        {
            ...
            case SnippetsFlowController.StepType.SnippetWithCustomAnim:
                ...
                DrawCustomAnimationField(rect, actorProp, customAnimationIndexProp, registry);
                rect.y += line + gap;
                if (customAnimationPlaybackModeProp != null)
                {
                    EditorGUI.PropertyField(
                        new Rect(rect.x, rect.y, rect.width, line),
                        customAnimationPlaybackModeProp,
