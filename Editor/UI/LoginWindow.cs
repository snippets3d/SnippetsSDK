    ...
    public class LoginWindow : EditorWindow
    {
        ...
        private async void TryLoginWithLastValidCredentials()
        {
            ...
            else
            {
                ...
                Debug.LogWarning($"[Snippets SDK] Login with last valid credentials failed. {response.Message}");
            }
        }
        ...
        private async void OnLoginButtonClicked()
        {
            ...
            {
                OnLoginSucceeded();
                SnippetsSetsWindow.ShowUsersSnippetsSets();
                Close();
            }
        ...
        {
            LoginStatus = LoginWindowStatus.LoggedOut;
            var errorMessage = response.Value == LoginResult.WrongCredentials
                ? "Wrong credentials"
